...
DEFAULT_PLAN_CATALOG = {
    'free': {
        ...
        'project_evaluation_estimate': '~1–2 evaluations',
    },
    'starter': {
        'label': 'Starter',
        'monthly_price_usd': 7,
        ...
        'self_serve': True,
        'sales_only': False,
        'description': 'Light personal use for approximately 5–8 evaluations.',
        'project_evaluation_estimate': '~5–8 evaluations',
    },
    'essential': {
        'label': 'Essential',
        ...
        'self_serve': True,
        'sales_only': False,
        'description': 'Turn ideas into clear decisions across approximately 40–55 evaluations.',
        'project_evaluation_estimate': '~40–55 evaluations',
    },
    'team': {
        'label': 'Team',
        ...
        'self_serve': True,
        'sales_only': False,
        'description': 'Align your team across approximately 165–230 evaluations from the shared allowance.',
        'project_evaluation_estimate': '~165–230 evaluations',
        'max_admin_seats': 3,
    ...
    'business': {
        ...
        'self_serve': True,
        'sales_only': False,
        'description': 'Bring structure and consistency across approximately 455–640 evaluations from the shared allowance.',
        'project_evaluation_estimate': '~455–640 evaluations',
        'max_admins': 5,
        'max_admin_seats': 5,

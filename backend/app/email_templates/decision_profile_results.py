          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; background:#ffffff; border:1px solid #cde7f0; border-radius:18px; overflow:hidden;">
            ...
            <tr>
              <td style="padding:34px 28px 26px; background:#161f3b;">
                <p style="margin:0 0 10px; font-size:13px; line-height:1.4; letter-spacing:.08em; text-transform:uppercase; color:#f0a6d4; font-weight:700;">Decision Profile</p>
                <h1 style="margin:0 0 14px; font-size:28px; line-height:1.18; color:#ffffff;">A better understanding of how you naturally decide</h1>
                <p style="margin:0 0 14px; font-size:16px; line-height:1.65; color:#d9deec;">Hi there,</p>
                <p style="margin:0 0 14px; font-size:16px; line-height:1.65; color:#d9deec;">Thank you for taking the Decision Profile assessment.</p>
                <p style="margin:0 0 14px; font-size:16px; line-height:1.65; color:#d9deec;">Every important decision leaves clues about how we naturally think. This assessment is designed to uncover some of those patterns so you can better understand your own decision-making process.</p>
                <p style="margin:0; font-size:16px; line-height:1.65; color:#d9deec;">Today, you discovered one of yours.</p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding:22px 28px; background:#161f3b;">
                <p style="margin:0 0 8px; font-size:13px; line-height:1.5; color:#d9deec;">You received this because you requested your Jaspen Decision Profile.</p>
                <p style="margin:0; font-size:13px; line-height:1.5; color:#d9deec;">You can unsubscribe from Jaspen updates <a href="{unsubscribe}" style="color:#f0a6d4;">here</a>.</p>
              </td>
            </tr>
          </table>
        </td>
